...
% if N==4
% plot(KMat(:,1),'-dr');hold on;
% plot(KMat(:,2),'-db');hold on;
% plot(KMat(:,3),'-dk');hold on;
% plot(KMat(:,4),'-dm');hold on;
% end
% if N==100
% plot(KMat(:,:),'-or');hold on;
% figure(3);
% plot(KMat(:,98),'-ob');hold on;
% plot(KMat(:,99),'-ok');hold on;
% plot(KMat(:,100),'-om');
% figure(4)
% plot(KMat(1,:),'-or');hold on;
% figure(5)
% plot(KMat(2,:),'-ob');hold on;
% figure(6)
% plot(KMat(3,:),'-og');hold on;
% figure(7)
% plot(KMat(4,:),'-ok');hold on;
% end
