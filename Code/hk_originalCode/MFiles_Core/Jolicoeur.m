...
%Geometry
%radiiVec=[0;  8e-3; (8e-3+1e-7); 14e-3];    % Sequence of Radii
%radiiVec=[0; 14e-3;]; 

nlay=1; 
polythick=1e-3; %thickness of polymer
outerRadius=1;


%radiiVec=linspace(0,14e-3,nlay);%2 Material Case
%radiiVec=radiiVec';

radiiVec=ComposeradiiVec_2(nlay,polythick,outerRadius);

%radiiVec=ComposeradiiVec_3(nlay,polythick);% Polymer+2 Other Material Case
...
%CMat=ComposeCMat_Jolicoeur(N);
%CMat=ComposeCMat_Jolicoeur_homo(N);
%CMat=ComposeCMat_3Mat(N,nu1,E1,nu2,E2,nu3,E3);
CMat=ComposeCMat_2Mat(N,nu1,E1,nu3,E3);
%CMat=ComposeCMat_Homo(N,nu1,E1); 
