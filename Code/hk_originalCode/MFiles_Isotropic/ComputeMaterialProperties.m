...
function [C, beta, mVec, muVec, gVec, mpVec, gpVec, UpVec, UppVec, VpVec, WpVec]= ComputeMaterialProperties(E,nu)
nDim=6;
...
gVec=zeros(4,1)
% for i=1:4
%  g(i,1)=beta(2,4)*m(i,1)^2+(beta(1,4)+beta(2,4))*m(i,1)-beta(5,6);
%  g(i,1)=g(i,1)/(beta(4,4)*m(i,1)^2-beta(5,5));
% end
